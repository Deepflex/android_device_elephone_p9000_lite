...
$(call inherit-product-if-exists, vendor/elephone/p9000_lite/p9000_lite-vendor.mk)

LOCAL_PATH := device/elephone/p9000_lite

# Overlays
DEVICE_PACKAGE_OVERLAYS += device/elephone/p9000_lite/overlay
